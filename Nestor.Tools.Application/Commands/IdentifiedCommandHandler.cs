...
{
    /// <summary>
    ///     Fournit une implémentation de base pour gérer les demandes en double et assurer des mises à jour idempotentes, dans
    ///     les cas où
    ...
    public class
        IdentifiedCommandHandler<TCommand, TResult> : IRequestHandler<IdentifiedCommand<TCommand, TResult>, TResult>
        where TCommand : IRequest<TResult>
    {
        ...
        /// <summary>
        ///     Cette méthode gère la commande.Il s'assure juste qu'aucune autre demande n'existe avec le même ID, et si c'est le
        ///     cas
