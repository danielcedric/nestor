...
namespace Nestor.Tools.Infrastructure.SqlKata.Abstractions
{
    public interface IDMLService
    {
        ...
        dynamic InsertData(DbConnection connection, dynamic obj, string table, string schema = "dbo", bool closeConnection = true);
        ...
        /// <param name="schema">Nom du schéma</param>
        /// <returns>Element ajouté</returns>
        dynamic InsertData(DbConnection connection, DbTransaction transaction, dynamic obj, string table, string schema = "dbo", bool closeConnection = true);
        /// <summary>
        ...
        /// <param name="schema">Nom du schéma</param>
        /// <returns></returns>
        IEnumerable<dynamic> InsertData(DbConnection connection, IEnumerable<dynamic> objs, string table, string schema = "dbo");
        /// <summary>
        ...
        /// <param name="schema">Nom du schéma</param>
        /// <returns></returns>
        Task<int> UpdateDataAsync(DbConnection connection, long id, IEnumerable<string> columns, IEnumerable<object> values, string table, string schema = "dbo", DbTransaction transaction = null);
        /// <summary>
        ...
        /// <returns></returns>
        Task<int> DeleteDataAsync(DbConnection connection, long id, string table, string schema = "dbo", DbTransaction transaction = null);
        /// <summary>
        ...
        /// <returns></returns>
        IEnumerable<dynamic> SelectData(DbConnection connection, IEnumerable<string> columns, string table, string schema, string joinTable, string joinOnForeignKey, string joinOnPrimaryKey, string column, object value, DbTransaction transaction = null);
        /// <summary>
        ...
        /// <param name="schema">Nom du schéma</param>
        /// <returns></returns>
        Task<dynamic> GetByIdAsync(DbConnection connection, long id, string table, string schema = "dbo", DbTransaction transaction = null, bool closeConnection = true);
        /// <summary>
        ...
        /// <returns></returns>
        IEnumerable<dynamic> GetFromRawSql(DbConnection connection, string rawSql, IEnumerable<object> parameters, bool closeConnection = true);
        /// <summary>
        /// Obtient le résultat d'une execution de requête SQL
        /// </summary>
        /// <param name="context">Contexte de la base de données</param>
        ...
        /// <returns></returns>
        IEnumerable<T> GetFromRawSql<T>(DbConnection connection, string rawSql, IEnumerable<object> parameters, bool closeConnection = true);
    }
}
