...
namespace Nestor.Tools.Helpers
{
    public class IOHelper
    {
        ...
        public static void Copy(string sourceDirName, string destDirName, bool copySubDirs)
        {
            ...
            if (!dir.Exists)
                throw new DirectoryNotFoundException(string.Format("Le répertoire source n'a pas été trouvé : {0}",
                    sourceDirName));
        ...
        public static Encoding DetectFileEncoding(FileStream fileStream)
        {
            ...
            {
                var bom = new byte[4]; // L'encodage est défini sur les 4 premiers octets.
        ...
        public static Encoding DetectFileEncoding(string filePath)
        {
            if (!File.Exists(filePath))
                throw new FileNotFoundException(
                    "Détection de l'encodage impossible, le fichier spécifié n'existe pas.");
        ...
        /// <summary>
        ///     Déplace un fichier d'un emplacement source vers une destination. Si celui-ci existe déjà dans le répertoire de
        ///     destination il est supprimé
        /// </summary>
        ...
        ///     Si vrai, et si le fichier existe déjà celui-ci sera supprimé à l'emplacement de
        ///     destination
        /// </param>
        /// <returns></returns>
