...
namespace Nestor.Tools.Helpers
{
    public class EmailHelper
    {
        ...
        public static void SendMail(string host, int port, string smtpUserName, string smtpPassword, string fromAddress,
            string toAddress, string header, string body)
        {
            ...
            var message = new MailMessage(!string.IsNullOrEmpty(fromAddress) ? fromAddress : fromAddress, toAddress);
