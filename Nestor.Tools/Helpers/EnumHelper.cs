...
namespace Nestor.Tools.Helpers
{
    public static class EnumHelper
    {
        ...
        {
            var enumValDescriptionList = new List<string>();
            foreach (var val in ToList<T>())
        ...
        {
            var enumValDescriptionList = new List<KeyValuePair<int, string>>();
            foreach (var val in ToList<T>())
                enumValDescriptionList.Add(new KeyValuePair<int, string>(Convert.ToInt32(val as Enum),
                    ToDescription(val as Enum)));
