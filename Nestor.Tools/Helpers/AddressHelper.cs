...
namespace Nestor.Tools.Helpers
{
    public class AddressHelper
    {
        ...
        public static GisgraphyResult ParseUsingGisgraphy(string address, string country = "fr")
        {
            ...
            {
                var cleanAddress = address.Replace(RegexHelper.RegexType.MultipleSpaces, " ");
                var uri =
                    $"http://services.gisgraphy.com/addressparser/?address={address}&country={country}&indent=false&format=json";
        ...
        public class AddressParseResult
        {
            ...
            /// <summary>
            ///     Affecte ou obtient le nom du lieu, il est nul dans la case d'adresse mais rempli si lieu commun. Le nom est
            ///     différent du nom du destinataire.
            /// </summary>
