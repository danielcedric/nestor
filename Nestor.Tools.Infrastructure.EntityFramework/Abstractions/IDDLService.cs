...
namespace Nestor.Tools.Infrastructure.Abstractions
{
    public interface IDDLService
    {
        ...
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> CreateTableAsync(DbContext context, string tableName, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        /// Créé une nouvelle colonne en base de données
        /// </summary>
        /// <param name="context">Contexte de  la base de données</param>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> AddColumnAsync<TColumn>(DbContext context, string tableName, string columnName, bool isNullable, object defaultValue, int? maxLength, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        /// Renomme la colonne
        /// </summary>
        /// <param name="context">Contexte de  la base de données</param>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> RenameColumnAsync(DbContext context, string tableName, string oldName, string newName, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> AlterColumnAsync<TColumn>(DbContext context, string tableName, string columnName, bool isNullable, object defaultValue, int? maxLength, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        ...
        Task<IEnumerable<DbOperationResult>> AddOneToManyRelationAsync(DbContext context, string principalTable, string foreignKeyColumnName, string foreignKeyConstraintName, string foreignTable, string schema, ReferentialAction onDelete, ReferentialAction onUpdate, bool isNullable, object defaultValue, bool updateDatabase = true);
        /// <summary>
        /// Créé une relation de type 1,n ou 0,n
        /// </summary>
        /// <param name="context">Contexte de  la base de données</param>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns>Liste des resultats des operations réalisées</returns>
        Task<IEnumerable<DbOperationResult>> AddOneToManyRelationAsync(DbContext context, string principalTable, string foreignKeyColumName, string foreignKeyConstraintName, string foreignTable, string principalTableSchema, string foreignTableSchema, ReferentialAction onDelete, ReferentialAction onUpdate, bool isNullable, object defaultValue, bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> DropForeignKey(DbContext context, string fkConstraintName, string columnName, string table, string schema, bool dropColumn = false, bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> DropColumn(DbContext context, string table, string column, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="schema">Schéma</param>
        /// <returns></returns>
        Task<bool> CheckIfColumnExistsInTable(DbContext context, string table, string column, string schema = "dbo", bool closeConnection = true);
        /// <summary>
        ...
        /// <param name="schema">Schéma</param>
        /// <returns></returns>
        Task<bool> CheckIfTableExists(DbContext context, string table, string schema = "dbo", bool closeConnection = true);
        /// <summary>
        ...
        /// <returns></returns>
        Task<IEnumerable<string>> GetColumnsAsync(DbContext context, string table, string schema = "dbo", bool closeConnection = true);
        /// <summary>
        ...
        /// <returns></returns>
        Task<ForeignKeyDescription> GetForeignKeyDescription(DbContext context, string constraintName, bool closeConnection = true);
        /// <summary>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<string> CreateIndexAsync(DbContext context, string table, IEnumerable<string> columns, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        /// Créé un index de performance
        /// </summary>
        /// <param name="context">Contexte de la base de données</param>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<string> CreateIndexAsync(DbContext context, string table, IEnumerable<string> columns, string indexName, string schema = "dbo",  bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<string> CreateUniqueIndexAsync(DbContext context, string table, IEnumerable<string> columns, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        /// Créé un index unique
        /// </summary>
        /// <param name="context">Contexte de la base de données</param>
        ...
        /// <param name="updateDatabase">Si vrai, met à jour la base de données</param>
        /// <returns></returns>
        Task<string> CreateUniqueIndexAsync(DbContext context, string table, IEnumerable<string> columns, string indexName, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        /// Supprime l'index
        /// </summary>
        /// <param name="context">Contexte de la base de données</param>
        ...
        /// <returns></returns>
        Task<IEnumerable<DbOperationResult>> DropIndex(DbContext context, string indexName, string table, string schema = "dbo", bool updateDatabase = true);
        /// <summary>
        ...
        /// <param name="schema">Nom du schéma</param>
        /// <returns></returns>
        Task<bool> CheckIfIndexExistsAsync(DbContext context, DbTransaction transaction, string indexName, string table, string schema = "dbo", bool closeConnection = true);
    }
}
