namespace Nestor.Tools.Infrastructure.EntityFramework
{
    public partial class Constants
    {
        ...
        /// </summary>
        public const string DefaultConnection = nameof(Constants.DefaultConnection);

        /// <summary>
        /// Section "Connexion Strings"
        /// </summary>
        public const string ConnectionStrings = nameof(Constants.ConnectionStrings);

        /// <summary>
        /// Nom de la section "Settings"
        /// </summary>
        public const string AppSettings = nameof(Constants.AppSettings);

        /// <summary>
        /// Nom de la section 
        /// </summary>
        public const string Database = nameof(Constants.Database);
        ...
        /// </summary>
        public const string Logging = nameof(Constants.Logging);
